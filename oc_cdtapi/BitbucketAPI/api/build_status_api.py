...
from typing_extensions import Annotated
from oc_cdtapi.BitbucketAPI.models.build_status import BuildStatus
from oc_cdtapi.BitbucketAPI.models.build_status_page import BuildStatusPage
...
class BuildStatusApi:
    ...
    @validate_call
    def get_build_statuses_paged(
        self,
        commit_hash: StrictStr,
        order_by: Annotated[Optional[StrictStr], Field(description="how the results should be ordered. Options are NEWEST, OLDEST, STATUS. Defaults to NEWEST if not provided.")] = None,
        ...
        :param order_by: how the results should be ordered. Options are NEWEST, OLDEST, STATUS. Defaults to NEWEST if not provided.
        :type order_by: str
        :param limit:
        :type limit: int
        :param start:
        ...
        _param = self._get_build_statuses_paged_serialize(
    ...
    @validate_call
    def get_build_statuses_paged_with_http_info(
        self,
        commit_hash: StrictStr,
        order_by: Annotated[Optional[StrictStr], Field(description="how the results should be ordered. Options are NEWEST, OLDEST, STATUS. Defaults to NEWEST if not provided.")] = None,
        limit: Optional[StrictInt] = None,
    ...
    @validate_call
    def get_build_statuses_paged_without_preload_content(
        self,
        commit_hash: StrictStr,
        order_by: Annotated[Optional[StrictStr], Field(description="how the results should be ordered. Options are NEWEST, OLDEST, STATUS. Defaults to NEWEST if not provided.")] = None,
        limit: Optional[StrictInt] = None,
    ...
    def _get_build_statuses_paged_serialize(
        self,
        commit_hash,
        order_by,
        limit,
        ...
        if commit_hash is not None:
            _path_params['commitHash'] = commit_hash
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/build-status/1.0/commits/{commitHash}',
    ...
    def post_build_result(
        ...
        :param commit_hash: (required)
        :type commit_hash: str
        :param build_status: Associates a build status with a commit.  The state, the key and the url are mandatory. The name and description fields are optional.  All fields (mandatory or optional) are limited to 255 characters, except for the url, which is limited to 450 characters.  Supported values for the state are SUCCESSFUL, FAILED and INPROGRESS.  The authenticated user must have LICENSED permission or higher to call this resource.
        ...
        _param = self._post_build_result_serialize(
            commit_hash=commit_hash,
    ...
    @validate_call
    def post_build_result_with_http_info(
        self,
        commit_hash: StrictStr,
        build_status: Annotated[Optional[BuildStatus], Field(description="Associates a build status with a commit.  The state, the key and the url are mandatory. The name and description fields are optional.  All fields (mandatory or optional) are limited to 255 characters, except for the url, which is limited to 450 characters.  Supported values for the state are SUCCESSFUL, FAILED and INPROGRESS.  The authenticated user must have LICENSED permission or higher to call this resource.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_build_result_without_preload_content(
        self,
        commit_hash: StrictStr,
        build_status: Annotated[Optional[BuildStatus], Field(description="Associates a build status with a commit.  The state, the key and the url are mandatory. The name and description fields are optional.  All fields (mandatory or optional) are limited to 255 characters, except for the url, which is limited to 450 characters.  Supported values for the state are SUCCESSFUL, FAILED and INPROGRESS.  The authenticated user must have LICENSED permission or higher to call this resource.")] = None,
        _request_timeout: Union[
    ...
    def _post_build_result_serialize(
        self,
        commit_hash,
        build_status,
        _request_auth,
