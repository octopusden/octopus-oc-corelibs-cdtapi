...
class CommitsApi:
    ...
    def get_commit(
        ...
        commit_id: StrictStr,
        path: Annotated[Optional[StrictStr], Field(description="an optional path to filter the commit by. If supplied the details returned may not be for the specified commit. Instead, starting from the specified commit, they will be the details for the first commit affecting the specified path.")] = None,
        ...
        :type commit_id: str
        :param path: an optional path to filter the commit by. If supplied the details returned may not be for the specified commit. Instead, starting from the specified commit, they will be the details for the first commit affecting the specified path.
        :type path: str
    ...
    def _get_commit_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/commits/{commitId}',
    ...
    def get_commits_paged(
        ...
        project_key: StrictStr,
        repository_slug: StrictStr,
        follow_renames: Annotated[Optional[StrictBool], Field(description="if true, the commit history of the specified file will be followed past renames. Only valid for a path to a single file.")] = None,
        ignore_missing: Annotated[Optional[StrictBool], Field(description="true to ignore missing commits, false otherwise")] = None,
        merges: Annotated[Optional[StrictStr], Field(description="  if present, controls how merge commits should be filtered. Can be either exclude, to exclude merge commits, include, to include both merge commits and non-merge commits or only, to only return merge commits.")] = None,
        path: Annotated[Optional[StrictStr], Field(description="an optional path to filter commits by")] = None,
        since: Annotated[Optional[StrictStr], Field(description="the commit ID or ref (exclusively) to retrieve commits after")] = None,
        until: Annotated[Optional[StrictStr], Field(description="the commit ID (SHA1) or ref (inclusively) to retrieve commits before")] = None,
        with_counts: Annotated[Optional[StrictBool], Field(description="optionally include the total number of commits and total number of unique authors")] = None,
        ...
        :param repository_slug: (required)
        :type repository_slug: str
        :param follow_renames: if true, the commit history of the specified file will be followed past renames. Only valid for a path to a single file.
        :type follow_renames: bool
        :param ignore_missing: true to ignore missing commits, false otherwise
        :type ignore_missing: bool
        :param merges:   if present, controls how merge commits should be filtered. Can be either exclude, to exclude merge commits, include, to include both merge commits and non-merge commits or only, to only return merge commits.
        :type merges: str
        ...
        :type until: str
        :param with_counts: optionally include the total number of commits and total number of unique authors
        ...
        _param = self._get_commits_paged_serialize(
            project_key=project_key,
            repository_slug=repository_slug,
    ...
    @validate_call
    def get_commits_paged_with_http_info(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        follow_renames: Annotated[Optional[StrictBool], Field(description="if true, the commit history of the specified file will be followed past renames. Only valid for a path to a single file.")] = None,
    ...
    @validate_call
    def get_commits_paged_without_preload_content(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        follow_renames: Annotated[Optional[StrictBool], Field(description="if true, the commit history of the specified file will be followed past renames. Only valid for a path to a single file.")] = None,
    ...
    def _get_commits_paged_serialize(
        self,
        project_key,
        repository_slug,
        follow_renames,
        ...
        if follow_renames is not None:
            ...
            _query_params.append(('followRenames', follow_renames))
            
        if ignore_missing is not None:
            
            _query_params.append(('ignoreMissing', ignore_missing))
            
        if merges is not None:
            
            _query_params.append(('merges', merges))
        ...
        if with_counts is not None:
            ...
            _query_params.append(('withCounts', with_counts))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/commits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
