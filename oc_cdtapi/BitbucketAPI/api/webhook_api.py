...
from typing_extensions import Annotated
from oc_cdtapi.BitbucketAPI.models.webhook import Webhook
from oc_cdtapi.BitbucketAPI.models.webhooks_page import WebhooksPage
...
class WebhookApi:
    ...
    def create_webhook(
        ...
        This API can also be invoked via a user-centric URL when addressing repositories in personal projects.  Create a webhook for the repository specified via the URL.  The authenticated user must have REPO_ADMIN permission for the specified repository to call this resource.
    ...
    def _create_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/webhooks',
    ...
    def delete_webhook(
        ...
        This API can also be invoked via a user-centric URL when addressing repositories in personal projects.  Delete a webhook for the repository specified via the URL.  The authenticated user must have REPO_ADMIN permission for the specified repository to call this resource.
    ...
    def _delete_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/webhooks/{webhookId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_webhook(
        ...
        This API can also be invoked via a user-centric URL when addressing repositories in personal projects.  Get a webhook by id.  The authenticated user must have REPO_ADMIN permission for the specified repository to call this resource.
    ...
    @validate_call
    def get_webhooks_paged(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        start: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        event: Annotated[Optional[StrictStr], Field(description="list of {@link com.atlassian.webhooks.WebhookEvent} ids to filter for")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This API can also be invoked via a user-centric URL when addressing repositories in personal projects.  Find webhooks in this repository.  The authenticated user must have REPO_ADMIN permission for the specified repository to call this resource.
        ...
        :param limit:
        :type limit: int
        :param event: list of {@link com.atlassian.webhooks.WebhookEvent} ids to filter for
        :type event: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_webhooks_paged_serialize(
            project_key=project_key,
            repository_slug=repository_slug,
            start=start,
            limit=limit,
    ...
    @validate_call
    def get_webhooks_paged_with_http_info(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        start: Optional[StrictInt] = None,
    ...
    @validate_call
    def get_webhooks_paged_without_preload_content(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        start: Optional[StrictInt] = None,
    ...
    def _get_webhooks_paged_serialize(
        self,
        project_key,
        repository_slug,
        start,
    ...
    def update_webhook(
        ...
        This API can also be invoked via a user-centric URL when addressing repositories in personal projects.  Update an existing webhook.  The authenticated user must have REPO_ADMIN permission for the specified repository to call this resource. 
