...
from oc_cdtapi.BitbucketAPI.models.post_webhook import PostWebhook
...
class PostWebhookApi:
    ...
    def delete_post_webhook(
        ...
        _param = self._delete_post_webhook_serialize(
    ...
    @validate_call
    def delete_post_webhook_with_http_info(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        id: StrictInt,
    ...
    @validate_call
    def delete_post_webhook_without_preload_content(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        id: StrictInt,
    ...
    def _delete_post_webhook_serialize(
        self,
        project_key,
        repository_slug,
        id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/webhook/1.0/projects/{projectKey}/repos/{repositorySlug}/configurations/{ID}',
    ...
    def get_post_webhooks(
        ...
        _param = self._get_post_webhooks_serialize(
            project_key=project_key,
            repository_slug=repository_slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_post_webhooks_with_http_info(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_post_webhooks_without_preload_content(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        _request_timeout: Union[
    ...
    def _get_post_webhooks_serialize(
        self,
        project_key,
        repository_slug,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/webhook/1.0/projects/{projectKey}/repos/{repositorySlug}/configurations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
