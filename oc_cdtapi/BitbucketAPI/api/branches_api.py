...
import warnings
from oc_cdtapi.BitbucketAPI.models.commits_page import CommitsPage
...
from typing_extensions import Annotated
from oc_cdtapi.BitbucketAPI.models.branch import Branch
from oc_cdtapi.BitbucketAPI.models.branches_page import BranchesPage
from oc_cdtapi.BitbucketAPI.models.create_branch import CreateBranch
from oc_cdtapi.BitbucketAPI.models.delete_branch import DeleteBranch
...
class BranchesApi:
    ...
    def create_branch(
        ...
        create_branch: Optional[CreateBranch] = None,
        ...
        Creates a branch in the specified repository.  The authenticated user must have an effective REPO_WRITE permission to call this resource. If branch permissions are set up in the repository, the authenticated user must also have access to the branch name that is to be created.
        ...
        :param create_branch:
        :type create_branch: CreateBranch
    ...
    def _create_branch_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/branch-utils/1.0/projects/{projectKey}/repos/{repositorySlug}/branches',
    ...
    def delete_branch(
        ...
        project_key: StrictStr,
        repository_slug: StrictStr,
        delete_branch: Optional[DeleteBranch] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type repository_slug: str
        :param delete_branch:
        :type delete_branch: DeleteBranch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    @validate_call
    def get_branches_paged(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        base: Annotated[Optional[StrictStr], Field(description="base branch or tag to compare each branch to (for the metadata providers that uses that information)")] = None,
        details: Annotated[Optional[StrictBool], Field(description="whether to retrieve plugin-provided metadata about each branch")] = None,
        filter_text: Annotated[Optional[StrictStr], Field(description="the text to match on")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="ordering of refs either ALPHABETICAL (by name) or MODIFICATION (last updated)")] = None,
        boost_matches: Annotated[Optional[StrictBool], Field(description="controls whether exact and prefix matches will be boosted to the top")] = None,
        ...
        Retrieve the branches matching the supplied filterText param.  The authenticated user must have REPO_READ permission for the specified repository to call this resource.
        ...
        :type details: bool
        :param filter_text: the text to match on
        :type filter_text: str
        :param order_by: ordering of refs either ALPHABETICAL (by name) or MODIFICATION (last updated)
        :type order_by: str
        :param boost_matches: controls whether exact and prefix matches will be boosted to the top
        :type boost_matches: bool
        :param start:
        :type start: int
        :param limit:
        :type limit: int
        ...
        _param = self._get_branches_paged_serialize(
            project_key=project_key,
            repository_slug=repository_slug,
            base=base,
            details=details,
    ...
    @validate_call
    def get_branches_paged_with_http_info(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        base: Annotated[Optional[StrictStr], Field(description="base branch or tag to compare each branch to (for the metadata providers that uses that information)")] = None,
    ...
    @validate_call
    def get_branches_paged_without_preload_content(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        base: Annotated[Optional[StrictStr], Field(description="base branch or tag to compare each branch to (for the metadata providers that uses that information)")] = None,
    ...
    def _get_branches_paged_serialize(
        self,
        project_key,
        repository_slug,
        base,
        ...
        if boost_matches is not None:
            ...
            _query_params.append(('boostMatches', boost_matches))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/branches',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_default_branch(
        ...
        Get the default branch of the repository.  The authenticated user must have REPO_READ permission for the specified repository to call this resource.
        ...
        _param = self._get_default_branch_serialize(
            project_key=project_key,
            repository_slug=repository_slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_default_branch_with_http_info(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_default_branch_without_preload_content(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        _request_timeout: Union[
    ...
    def _get_default_branch_serialize(
        self,
        project_key,
        repository_slug,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/branches/default',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_compare_branches(
        self,
        project_key: StrictStr,
        repository_slug: StrictStr,
        from_branch: StrictStr,
        to_branch: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_compare_branches_serialize(
            project_key=project_key,
            repository_slug=repository_slug,
    ...
    def _get_compare_branches_serialize(
        self,
        project_key,
        repository_slug,
        from_branch,
        ...
        if from_branch is not None:
            _query_params.append(('from', from_branch))
        if to_branch is not None:
            _query_params.append(('to', to_branch))
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/1.0/projects/{projectKey}/repos/{repositorySlug}/compare/commits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
