...
class RepositoriesPage(BaseModel):
    """
    RepositoriesPage
    """ # noqa: E501
    size: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoriesPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoriesPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "values": [Repository.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
