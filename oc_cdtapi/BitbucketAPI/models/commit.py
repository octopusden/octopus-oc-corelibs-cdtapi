...
from oc_cdtapi.BitbucketAPI.models.commit_parents_inner import CommitParentsInner
...
class Commit(BaseModel):
    ...
    author: User
    author_timestamp: StrictInt = Field(alias="authorTimestamp")
    committer: User
    committer_timestamp: StrictInt = Field(alias="committerTimestamp")
    message: StrictStr
    parents: Optional[List[CommitParentsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "displayId", "author", "authorTimestamp", "committer", "committerTimestamp", "message", "parents"]
