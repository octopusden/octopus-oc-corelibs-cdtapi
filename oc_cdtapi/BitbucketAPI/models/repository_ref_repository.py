...
from oc_cdtapi.BitbucketAPI.models.repository_ref_repository_project import RepositoryRefRepositoryProject
from typing import Optional, Set
from typing_extensions import Self

class RepositoryRefRepository(BaseModel):
    """
    RepositoryRefRepository
    """ # noqa: E501
    slug: StrictStr
    name: Optional[StrictStr] = None
    project: RepositoryRefRepositoryProject
    __properties: ClassVar[List[str]] = ["slug", "name", "project"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryRefRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryRefRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "slug": obj.get("slug"),
            "name": obj.get("name"),
            "project": RepositoryRefRepositoryProject.from_dict(obj["project"]) if obj.get("project") is not None else None
        })
        return _obj
