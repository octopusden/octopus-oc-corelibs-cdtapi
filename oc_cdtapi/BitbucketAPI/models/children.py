...
from oc_cdtapi.BitbucketAPI.models.children_all_of_values import ChildrenAllOfValues
...
class Children(BaseModel):
    ...
    values: Optional[List[ChildrenAllOfValues]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [ChildrenAllOfValues.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
