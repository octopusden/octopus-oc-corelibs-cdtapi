...
class BranchMetadataAheadBehind(BaseModel):
    """
    BranchMetadataAheadBehind
    """ # noqa: E501
    ahead: StrictInt
    behind: StrictInt
    __properties: ClassVar[List[str]] = ["ahead", "behind"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BranchMetadataAheadBehind from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BranchMetadataAheadBehind from a dict"""
        if obj is None:
            return None
