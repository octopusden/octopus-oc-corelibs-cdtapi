...
class CommitsPage(BaseModel):
    ...
    values: List[Commit]
    author_count: Optional[StrictInt] = Field(default=None, alias="authorCount")
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    __properties: ClassVar[List[str]] = ["size", "limit", "start", "isLastPage", "nextPageStart", "values", "authorCount", "totalCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommitsPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommitsPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "values": [Commit.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
