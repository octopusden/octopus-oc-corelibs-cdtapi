...
from oc_cdtapi.BitbucketAPI.models.children import Children
from oc_cdtapi.BitbucketAPI.models.file_lines_inner import FileLinesInner
...
class FileOrDirectory(BaseModel):
    ...
    lines: Optional[List[FileLinesInner]] = None
    path: Optional[Path] = None
    revision: Optional[StrictStr] = None
    children: Optional[Children] = None
    __properties: ClassVar[List[str]] = ["start", "size", "isLastPage", "lines", "path", "revision", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lines": [FileLinesInner.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None,
            "path": Path.from_dict(obj["path"]) if obj.get("path") is not None else None,
            "revision": obj.get("revision"),
            "children": Children.from_dict(obj["children"]) if obj.get("children") is not None else None
        })
        return _obj
