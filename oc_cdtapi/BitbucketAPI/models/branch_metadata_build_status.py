...
class BranchMetadataBuildStatus(BaseModel):
    """
    ...
    failed: StrictInt
    __properties: ClassVar[List[str]] = ["successful", "inProgress", "failed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BranchMetadataBuildStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BranchMetadataBuildStatus from a dict"""
        if obj is None:
            return None
