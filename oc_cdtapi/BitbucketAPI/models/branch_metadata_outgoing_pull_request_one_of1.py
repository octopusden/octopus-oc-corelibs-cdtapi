...
class BranchMetadataOutgoingPullRequestOneOf1(BaseModel):
    """
    ...
    merged: StrictInt
    declined: StrictInt
    __properties: ClassVar[List[str]] = ["open", "merged", "declined"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BranchMetadataOutgoingPullRequestOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BranchMetadataOutgoingPullRequestOneOf1 from a dict"""
        if obj is None:
            return None
