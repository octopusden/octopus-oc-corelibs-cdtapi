...
class PostWebhook(BaseModel):
    ...
    PostWebhook
    """ # noqa: E501
    branch_created: Optional[StrictBool] = Field(default=None, alias="branchCreated")
    branch_deleted: Optional[StrictBool] = Field(default=None, alias="branchDeleted")
    branches_to_ignore: StrictStr = Field(alias="branchesToIgnore")
    build_status: Optional[StrictBool] = Field(default=None, alias="buildStatus")
    committers_to_ignore: StrictStr = Field(alias="committersToIgnore")
    enabled: StrictBool
    id: StrictInt
    pr_commented: Optional[StrictBool] = Field(default=None, alias="prCommented")
    pr_created: Optional[StrictBool] = Field(default=None, alias="prCreated")
    pr_declined: Optional[StrictBool] = Field(default=None, alias="prDeclined")
    pr_merged: Optional[StrictBool] = Field(default=None, alias="prMerged")
    pr_reopened: Optional[StrictBool] = Field(default=None, alias="prReopened")
    pr_rescoped: Optional[StrictBool] = Field(default=None, alias="prRescoped")
    pr_updated: Optional[StrictBool] = Field(default=None, alias="prUpdated")
    repo_push: Optional[StrictBool] = Field(default=None, alias="repoPush")
    tag_created: Optional[StrictBool] = Field(default=None, alias="tagCreated")
    title: StrictStr
    url: StrictStr
    __properties: ClassVar[List[str]] = ["branchCreated", "branchDeleted", "branchesToIgnore", "buildStatus", "committersToIgnore", "enabled", "id", "prCommented", "prCreated", "prDeclined", "prMerged", "prReopened", "prRescoped", "prUpdated", "repoPush", "tagCreated", "title", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branchCreated": obj.get("branchCreated"),
            "branchDeleted": obj.get("branchDeleted"),
            "branchesToIgnore": obj.get("branchesToIgnore"),
            "buildStatus": obj.get("buildStatus"),
            "committersToIgnore": obj.get("committersToIgnore"),
            "enabled": obj.get("enabled"),
            "id": obj.get("id"),
            "prCommented": obj.get("prCommented"),
            "prCreated": obj.get("prCreated"),
            "prDeclined": obj.get("prDeclined"),
            "prMerged": obj.get("prMerged"),
            "prReopened": obj.get("prReopened"),
            "prRescoped": obj.get("prRescoped"),
            "prUpdated": obj.get("prUpdated"),
            "repoPush": obj.get("repoPush"),
            "tagCreated": obj.get("tagCreated"),
            "title": obj.get("title"),
            "url": obj.get("url")
        })
        return _obj
