...
from oc_cdtapi.BitbucketAPI.models.repository_links import RepositoryLinks
...
class Repository(BaseModel):
    ...
    public: StrictBool
    project: Project
    links: Optional[RepositoryLinks] = None
    __properties: ClassVar[List[str]] = ["id", "slug", "name", "hierarchyId", "scmId", "state", "statusMessage", "forkable", "public", "project", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": RepositoryLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
