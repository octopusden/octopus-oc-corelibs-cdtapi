...
from oc_cdtapi.BitbucketAPI.models.errors_errors_inner import ErrorsErrorsInner
...
class Errors(BaseModel):
    ...
    Errors
    """ # noqa: E501
    errors: Optional[List[ErrorsErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ErrorsErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
