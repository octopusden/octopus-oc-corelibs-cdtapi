...
from oc_cdtapi.BitbucketAPI.models.repository_ref_repository import RepositoryRefRepository
...
class RepositoryRef(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    repository: RepositoryRefRepository
    __properties: ClassVar[List[str]] = ["id", "repository"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryRef from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "repository": RepositoryRefRepository.from_dict(obj["repository"]) if obj.get("repository") is not None else None
        })
        return _obj
