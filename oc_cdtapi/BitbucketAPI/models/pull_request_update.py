...
class PullRequestUpdate(BaseModel):
    ...
    to_ref: Optional[RepositoryRef] = Field(default=None, alias="toRef")
    __properties: ClassVar[List[str]] = ["id", "version", "title", "description", "reviewers", "toRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PullRequestUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PullRequestUpdate from a dict"""
        if obj is None:
            return None
