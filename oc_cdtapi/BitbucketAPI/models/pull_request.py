...
from oc_cdtapi.BitbucketAPI.models.project_links import ProjectLinks
from oc_cdtapi.BitbucketAPI.models.pull_request_state import PullRequestState
from oc_cdtapi.BitbucketAPI.models.repository_ref import RepositoryRef
from oc_cdtapi.BitbucketAPI.models.user_role import UserRole
...
class PullRequest(BaseModel):
    ...
    from_ref: RepositoryRef = Field(alias="fromRef")
    to_ref: RepositoryRef = Field(alias="toRef")
    locked: Optional[StrictBool] = None
    author: Optional[UserRole] = None
    reviewers: Optional[List[UserRole]] = None
    participants: Optional[List[UserRole]] = None
    links: Optional[ProjectLinks] = None
    __properties: ClassVar[List[str]] = ["id", "version", "title", "description", "state", "open", "closed", "createdDate", "updatedDate", "fromRef", "toRef", "locked", "author", "reviewers", "participants", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fromRef": RepositoryRef.from_dict(obj["fromRef"]) if obj.get("fromRef") is not None else None,
            "toRef": RepositoryRef.from_dict(obj["toRef"]) if obj.get("toRef") is not None else None,
            "locked": obj.get("locked"),
            "author": UserRole.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "reviewers": [UserRole.from_dict(_item) for _item in obj["reviewers"]] if obj.get("reviewers") is not None else None,
            "participants": [UserRole.from_dict(_item) for _item in obj["participants"]] if obj.get("participants") is not None else None,
