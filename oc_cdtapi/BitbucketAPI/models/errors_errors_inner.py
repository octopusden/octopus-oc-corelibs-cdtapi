...
class ErrorsErrorsInner(BaseModel):
    """
    ErrorsErrorsInner
    """ # noqa: E501
    context: Optional[StrictStr] = None
    message: StrictStr
    exception_name: Optional[StrictStr] = Field(default=None, alias="exceptionName")
    __properties: ClassVar[List[str]] = ["context", "message", "exceptionName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exceptionName": obj.get("exceptionName")
        })
        return _obj
