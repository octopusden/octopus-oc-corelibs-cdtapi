...
class BranchMetadataOutgoingPullRequestOneOf(BaseModel):
    """
    BranchMetadataOutgoingPullRequestOneOf
    """ # noqa: E501
    pull_request: PullRequest = Field(alias="pullRequest")
    __properties: ClassVar[List[str]] = ["pullRequest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BranchMetadataOutgoingPullRequestOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BranchMetadataOutgoingPullRequestOneOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "pullRequest": PullRequest.from_dict(obj["pullRequest"]) if obj.get("pullRequest") is not None else None
        })
        return _obj
