...
from oc_cdtapi.BitbucketAPI.models.webhook_configuration import WebhookConfiguration
from oc_cdtapi.BitbucketAPI.models.webhook_event import WebhookEvent
...
class Webhook(BaseModel):
    ...
    configuration: Optional[WebhookConfiguration] = None
    url: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "createDate", "updatedDate", "events", "configuration", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configuration": WebhookConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "url": obj.get("url")
        })
        return _obj
