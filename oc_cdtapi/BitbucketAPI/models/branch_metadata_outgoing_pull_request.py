...
from oc_cdtapi.BitbucketAPI.models.branch_metadata_outgoing_pull_request_one_of import BranchMetadataOutgoingPullRequestOneOf
from oc_cdtapi.BitbucketAPI.models.branch_metadata_outgoing_pull_request_one_of1 import BranchMetadataOutgoingPullRequestOneOf1
from pydantic import StrictStr, Field
from typing import Union, List, Set, Optional, Dict
from typing_extensions import Literal, Self

BRANCHMETADATAOUTGOINGPULLREQUEST_ONE_OF_SCHEMAS = ["BranchMetadataOutgoingPullRequestOneOf", "BranchMetadataOutgoingPullRequestOneOf1"]

class BranchMetadataOutgoingPullRequest(BaseModel):
    """
    BranchMetadataOutgoingPullRequest
    """
    # data type: BranchMetadataOutgoingPullRequestOneOf
    oneof_schema_1_validator: Optional[BranchMetadataOutgoingPullRequestOneOf] = None
    # data type: BranchMetadataOutgoingPullRequestOneOf1
    oneof_schema_2_validator: Optional[BranchMetadataOutgoingPullRequestOneOf1] = None
    actual_instance: Optional[Union[BranchMetadataOutgoingPullRequestOneOf, BranchMetadataOutgoingPullRequestOneOf1]] = None
    one_of_schemas: Set[str] = { "BranchMetadataOutgoingPullRequestOneOf", "BranchMetadataOutgoingPullRequestOneOf1" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = BranchMetadataOutgoingPullRequest.model_construct()
        error_messages = []
        match = 0
        # validate data type: BranchMetadataOutgoingPullRequestOneOf
        if not isinstance(v, BranchMetadataOutgoingPullRequestOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BranchMetadataOutgoingPullRequestOneOf`")
        else:
            match += 1
        # validate data type: BranchMetadataOutgoingPullRequestOneOf1
        if not isinstance(v, BranchMetadataOutgoingPullRequestOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BranchMetadataOutgoingPullRequestOneOf1`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in BranchMetadataOutgoingPullRequest with oneOf schemas: BranchMetadataOutgoingPullRequestOneOf, BranchMetadataOutgoingPullRequestOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in BranchMetadataOutgoingPullRequest with oneOf schemas: BranchMetadataOutgoingPullRequestOneOf, BranchMetadataOutgoingPullRequestOneOf1. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into BranchMetadataOutgoingPullRequestOneOf
        try:
            instance.actual_instance = BranchMetadataOutgoingPullRequestOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BranchMetadataOutgoingPullRequestOneOf1
        try:
            instance.actual_instance = BranchMetadataOutgoingPullRequestOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into BranchMetadataOutgoingPullRequest with oneOf schemas: BranchMetadataOutgoingPullRequestOneOf, BranchMetadataOutgoingPullRequestOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into BranchMetadataOutgoingPullRequest with oneOf schemas: BranchMetadataOutgoingPullRequestOneOf, BranchMetadataOutgoingPullRequestOneOf1. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BranchMetadataOutgoingPullRequestOneOf, BranchMetadataOutgoingPullRequestOneOf1]]:
