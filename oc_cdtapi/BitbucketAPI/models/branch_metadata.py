...
from oc_cdtapi.BitbucketAPI.models.branch_metadata_ahead_behind import BranchMetadataAheadBehind
from oc_cdtapi.BitbucketAPI.models.branch_metadata_build_status import BranchMetadataBuildStatus
from oc_cdtapi.BitbucketAPI.models.branch_metadata_jira_issue import BranchMetadataJiraIssue
from oc_cdtapi.BitbucketAPI.models.branch_metadata_outgoing_pull_request import BranchMetadataOutgoingPullRequest
from oc_cdtapi.BitbucketAPI.models.commit import Commit
...
class BranchMetadata(BaseModel):
    ...
    BranchMetadata
    """ # noqa: E501
    com_atlassian_bitbucket_server_bitbucket_branch_ahead_behind_metadata_provider: Optional[BranchMetadataAheadBehind] = Field(default=None, alias="com.atlassian.bitbucket.server.bitbucket-branch:ahead-behind-metadata-provider")
    com_atlassian_bitbucket_server_bitbucket_branch_latest_commit_metadata: Optional[Commit] = Field(default=None, alias="com.atlassian.bitbucket.server.bitbucket-branch:latest-commit-metadata")
    com_atlassian_bitbucket_server_bitbucket_build_build_status_metadata: Optional[BranchMetadataBuildStatus] = Field(default=None, alias="com.atlassian.bitbucket.server.bitbucket-build:build-status-metadata")
    com_atlassian_bitbucket_server_bitbucket_ref_metadata_outgoing_pull_request_metadata: Optional[BranchMetadataOutgoingPullRequest] = Field(default=None, alias="com.atlassian.bitbucket.server.bitbucket-ref-metadata:outgoing-pull-request-metadata")
    com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues: Optional[List[BranchMetadataJiraIssue]] = Field(default=None, alias="com.atlassian.bitbucket.server.bitbucket-jira:branch-list-jira-issues")
    __properties: ClassVar[List[str]] = ["com.atlassian.bitbucket.server.bitbucket-branch:ahead-behind-metadata-provider", "com.atlassian.bitbucket.server.bitbucket-branch:latest-commit-metadata", "com.atlassian.bitbucket.server.bitbucket-build:build-status-metadata", "com.atlassian.bitbucket.server.bitbucket-ref-metadata:outgoing-pull-request-metadata", "com.atlassian.bitbucket.server.bitbucket-jira:branch-list-jira-issues"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BranchMetadata from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of com_atlassian_bitbucket_server_bitbucket_branch_ahead_behind_metadata_provider
        if self.com_atlassian_bitbucket_server_bitbucket_branch_ahead_behind_metadata_provider:
            _dict['com.atlassian.bitbucket.server.bitbucket-branch:ahead-behind-metadata-provider'] = self.com_atlassian_bitbucket_server_bitbucket_branch_ahead_behind_metadata_provider.to_dict()
        # override the default output from pydantic by calling `to_dict()` of com_atlassian_bitbucket_server_bitbucket_branch_latest_commit_metadata
        if self.com_atlassian_bitbucket_server_bitbucket_branch_latest_commit_metadata:
            _dict['com.atlassian.bitbucket.server.bitbucket-branch:latest-commit-metadata'] = self.com_atlassian_bitbucket_server_bitbucket_branch_latest_commit_metadata.to_dict()
        # override the default output from pydantic by calling `to_dict()` of com_atlassian_bitbucket_server_bitbucket_build_build_status_metadata
        if self.com_atlassian_bitbucket_server_bitbucket_build_build_status_metadata:
            _dict['com.atlassian.bitbucket.server.bitbucket-build:build-status-metadata'] = self.com_atlassian_bitbucket_server_bitbucket_build_build_status_metadata.to_dict()
        # override the default output from pydantic by calling `to_dict()` of com_atlassian_bitbucket_server_bitbucket_ref_metadata_outgoing_pull_request_metadata
        if self.com_atlassian_bitbucket_server_bitbucket_ref_metadata_outgoing_pull_request_metadata:
            _dict['com.atlassian.bitbucket.server.bitbucket-ref-metadata:outgoing-pull-request-metadata'] = self.com_atlassian_bitbucket_server_bitbucket_ref_metadata_outgoing_pull_request_metadata.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues (list)
        _items = []
        if self.com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues:
            for _item_com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues in self.com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues:
                if _item_com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues:
                    _items.append(_item_com_atlassian_bitbucket_server_bitbucket_jira_branch_list_jira_issues.to_dict())
            _dict['com.atlassian.bitbucket.server.bitbucket-jira:branch-list-jira-issues'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BranchMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "com.atlassian.bitbucket.server.bitbucket-branch:ahead-behind-metadata-provider": BranchMetadataAheadBehind.from_dict(obj["com.atlassian.bitbucket.server.bitbucket-branch:ahead-behind-metadata-provider"]) if obj.get("com.atlassian.bitbucket.server.bitbucket-branch:ahead-behind-metadata-provider") is not None else None,
            "com.atlassian.bitbucket.server.bitbucket-branch:latest-commit-metadata": Commit.from_dict(obj["com.atlassian.bitbucket.server.bitbucket-branch:latest-commit-metadata"]) if obj.get("com.atlassian.bitbucket.server.bitbucket-branch:latest-commit-metadata") is not None else None,
            "com.atlassian.bitbucket.server.bitbucket-build:build-status-metadata": BranchMetadataBuildStatus.from_dict(obj["com.atlassian.bitbucket.server.bitbucket-build:build-status-metadata"]) if obj.get("com.atlassian.bitbucket.server.bitbucket-build:build-status-metadata") is not None else None,
            "com.atlassian.bitbucket.server.bitbucket-ref-metadata:outgoing-pull-request-metadata": BranchMetadataOutgoingPullRequest.from_dict(obj["com.atlassian.bitbucket.server.bitbucket-ref-metadata:outgoing-pull-request-metadata"]) if obj.get("com.atlassian.bitbucket.server.bitbucket-ref-metadata:outgoing-pull-request-metadata") is not None else None,
            "com.atlassian.bitbucket.server.bitbucket-jira:branch-list-jira-issues": [BranchMetadataJiraIssue.from_dict(_item) for _item in obj["com.atlassian.bitbucket.server.bitbucket-jira:branch-list-jira-issues"]] if obj.get("com.atlassian.bitbucket.server.bitbucket-jira:branch-list-jira-issues") is not None else None
        })
        return _obj
