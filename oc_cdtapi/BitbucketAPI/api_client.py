...
from oc_cdtapi.BitbucketAPI.configuration import Configuration
from oc_cdtapi.BitbucketAPI.api_response import ApiResponse, T as ApiResponseT
import oc_cdtapi.BitbucketAPI.models
from oc_cdtapi.BitbucketAPI import rest
from oc_cdtapi.BitbucketAPI.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def param_serialize(
        ...
        if not auth_settings:
            auth_settings = [auth for auth in self.configuration.auth_settings()]
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(oc_cdtapi.BitbucketAPI.models, klass)
